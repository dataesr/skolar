...
PARAGRAPH_TYPE = "clinicaltrial"
LANGS = ["en", "fr", "es", "pt", "it", "de"]


def clinicaltrial_filter(publication_id, paragraphs) -> list:
    """
    Filter paragraphs to keep only the ones that are likely to be clinicaltrial.
